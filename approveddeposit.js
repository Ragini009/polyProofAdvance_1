...
const ABI = require("../artifacts/contracts/krishna.sol/krishna.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("krishna");
  const nft = await NFT.attach("0x43Fc7956F17e1f12E2e79f879ff78d469b4d3E01");
